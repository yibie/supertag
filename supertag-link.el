...
(autoload 'supertag-view-helper-insert-section-title "supertag-view-framework")
(declare-function supertag-view-helper-insert-section-title "supertag-view-framework" (title &optional icon))
(autoload 'supertag-view-helper-insert-simple-empty-state "supertag-view-framework")
(declare-function supertag-view-helper-insert-simple-empty-state "supertag-view-framework" (message))
